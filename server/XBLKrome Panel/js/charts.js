        ...
        init: function(){
            ...
            if($("#dashboard-chart").length > 0){
                ...
                var rdc = new Rickshaw.Graph( {
                        ...
                        height: 250,
                        series: [{color: "#334454",data: seriesData[0],name: 'Total'}, 
                                 {color: "#8CC152",data: seriesData[1],name: 'New'}, 
                                 {color: "#F6BB42",data: seriesData[2],name: 'Returned'}]
                } );
            ...
            if($("#charts-legend").length > 0){
                ...
                var rcl = new Rickshaw.Graph( {
                        ...
                        series: [{color: "#2f9fe0",data: seriesData[0],name: 'Total'}, 
                                 {color: "#8CC152",data: seriesData[1],name: 'New'}, 
                                 {color: "#DA4453",data: seriesData[2],name: 'Returned'}]
                } );
